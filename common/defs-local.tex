...
\def\tdrtitle{Near Detector Conceptual Design Report}
...
\newcommand{\nch}{\ensuremath{\left\langle n_{ch} \right\rangle}}



\DeclareUnicodeCharacter{223C}{~} % for error (inputenc)  not set up for use with LaTeX.
