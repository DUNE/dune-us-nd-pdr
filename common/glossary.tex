...
\newduneabbrev{tki}{TKI}{transverse kinematic imbalance}{TKI variables are formed assuming transverse momentum conservation of the outgoing particles in a neutrino interaction} % from SManley 12/2/20 via email
...
\newduneword{echain}{energy chain}{mechanical machine elements used to carry and guide power to moving parts of machines or structures, as required for \gls{duneprism} to carry power, data, and utilities to and from each detector at any arbitrary position along the detector travel path}
