...
{Spectrum of $\nu_\mu$, $\nu_e$}
  \subfloat[][$E_{\rm rec}$]{
    \includegraphics[width=0.45\textwidth]{graphics/introduction/spec_app_nu_no.pdf}

    %\label{fig:fd_nue}
  }
  \subfloat[][$E_{\rm proton}^{dep}$]{
    \includegraphics[width=0.45\linewidth]{graphics/introduction/spec_dis_nu_no.pdf}
    %\label{fig:fd_numu}
  }
\end{dunefigure}
...
\include{generated/spec-longtable-nd-overarch}

\include{generated/spec-longtable-nd-meas}

\include{generated/spec-longtable-nd-cap}
...
{Spectrum of $\nu_\mu$, $\nu_e$}
  \subfloat[][$E_{\rm rec}$]{
    \includegraphics[width=0.45\textwidth]{graphics/introduction/hist_stop0_Erec_osc_noRW.png}

    %\label{fig:eproton_ndspec}
  }
  \subfloat[][$E_{res}$]{
    \includegraphics[width=0.45\linewidth]{graphics/introduction/FHC_Enu_Erec_fracDiff1D_m20pcProtonE.png}
...
{Spectrum of $\nu_\mu$, $\nu_e$}
  \subfloat[][$Q^2$]{
    \includegraphics[width=0.45\textwidth]{graphics/introduction/PiStudyDataMCRatioTrueFHC.pdf}
    %\label{fig:eproton_ndspec}
  }
  \subfloat[][$\delta_{CP}$ ]{
    \includegraphics[width=0.45\linewidth]{graphics/introduction/PiStudyBiasWithGAr.pdf}
    %\label{fig:eproton_enures}
  }
\end{dunefigure}
...
\end{itemize}
%Together, both experimental and theoretical considerations indicate that 
